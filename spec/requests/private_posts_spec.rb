...
RSpec.describe 'Posts with authentication', type: :request do
  ...
  let!(:create_params) { {"post" => { "title" => "any title", "content" => "any content", "published" => true } } }
  let!(:update_params) { {"post" => { "title" => "any new title", "content" => "any new content", "published" => true } } }

  # Authorization: Bearer xxxxxx

  describe 'GET /posts{id}' do
    context 'with valid auth' do
      context "when requesting other author's post" do
